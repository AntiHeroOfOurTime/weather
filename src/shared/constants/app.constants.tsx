...
export const weatherCode = [
    {
        code:0,
        name:'чистое небо',
        icon:(className:string='')=><Clear className={` w-[50px] h-[50px] fill-yellow-400 stroke-yellow-400 ${className}`}/>
    },
    {
        code:1,
        name:'ясно',
    ...
    },
    {
        ...
        icon:(className:string='')=><Cloudy className={`w-[50px] h-[50px] stroke-blue-500 fill-blue-500 ${className}`}/>
    },
    {
        code:45,
        name:'туман',
    ...
    },
    {
        ...
        icon:(className:string='')=><Rainy4 className={`w-[50px] h-[50px] stroke-blue-500 fill-blue-500 ${className}`}/>
    },{
        code:53,
    ...
    },
    {
        ...
        icon:(className:string='')=><Rainy4 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:57,
    ...
    },
    {
        code:61,
        name:'слабый дождь',
        icon:(className:string='')=><Rainy1 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:63,
        name:'умеренный дождь',
        icon:(className:string='')=><Rainy2 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:65,
        name:'сильный дождь',
        icon:(className:string='')=><Rainy3 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:66,
    ...
    },
    {
        ...
        icon:(className:string='')=><Snow3 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:73,
    ...
    },
    {
        code:85,
        name:'слабый снег',
        icon:(className:string='')=><Snow1 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:86,
        name:'сильный снег',
        icon:(className:string='')=><Snow2 className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:95,
        name: 'гроза',
        icon:(className:string='')=><Thunder className={`stroke-blue-500 w-[50px] h-[50px] fill-blue-500 ${className}`}/>
    },
    {
        code:96,
...
export const REQUEST_PARAMS = {
       daily:{
         daily:'precipitation_sum,temperature_2m_max,temperature_2m_min,weathercode,winddirection_10m_dominant,windspeed_10m_max',
         timezone:'auto',
